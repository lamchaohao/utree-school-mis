  ...
  <div class="app-container">
    ...
    >
      <el-table-column
        ...
        align="center"
        width="80"
        :class-name="getSortClass('schoolYearCode')"
      >
        <template slot-scope="{row}">
          <span>{{ row.schoolYearId }}</span>
        </template>
      </el-table-column>
      <el-table-column label="学年" min-width="150px" align="center">
        <template slot-scope="{row}">
      ...
      <el-table-column label="学期" width="110px" align="center">
        <template slot-scope="{row}">
            <el-tag>{{ row.serial }}</el-tag>
        </template>
      </el-table-column>
...
//   updateArticle
// } from "@/api/article";
import {fetchSchoolYearList} from "@/api/eduadmin/school-year-admin";
...
export default {
  ...
  methods: {
    ...
    fetchSchoolYearList(0,10).then(response => {
        console.log('response',response)
          this.list = response.result.list;
          this.total = response.result.list.length;
