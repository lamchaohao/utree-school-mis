...
export const constantRoutes = [{
...

    {
        path: '/eduAdmin',
        component: Layout,
        redirect: '/eduAdmin/school-year-admin',
        name: 'eduAdmin',
        meta: { title: '教务管理', icon: 'example' },
        children: [{
                path: 'school-year-admin',
                name: 'school-year-admin',
                component: () =>
                    import ('@/views/eduadmin/school-year-admin'),
                meta: { title: '学年管理', icon: 'table' }
            },
            {
                path: 'subjects-admin',
                name: 'subjects-admin',
                component: () =>
                    import ('@/views/eduadmin/subjects-admin'),
            ...
            },
            {
                ...
                name: 'Tree',
                component: () =>
                    import ('@/views/eduadmin/teachers-admin'),
            ...
            },
            {
                ...
                name: 'class-admin',
                component: () =>
                    import ('@/views/eduadmin/class-admin'),
            ...
            },
            {
                ...
                name: 'student-admin',
                component: () =>
                    import ('@/views/eduadmin/student-admin'),
